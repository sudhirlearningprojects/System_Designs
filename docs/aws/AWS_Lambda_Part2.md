# AWS Lambda - Complete Guide (Part 2)
...
**Note**: This is Part 2 of the AWS Lambda Complete Guide. For basic concepts, triggers, and best practices, see [AWS_Lambda_Part1.md](AWS_Lambda_Part1.md)
